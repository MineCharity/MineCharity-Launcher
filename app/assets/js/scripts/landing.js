        ...
        setDismissHandler(() => {
            $('#overlayContent').fadeOut(250, () => {
                ...
                setOverlayContent(
                    ...
                    `A valid x64 installation of Java ${effectiveJavaOptions.suggestedMajor} is required to launch.<br><br>Please refer to our <a href="https://github.com/MineCharity/MineCharity-Launcher/wiki/Java-Management#manually-installing-a-valid-version-of-java">Java Management Guide</a> for instructions on how to manually install Java.`,
                    'I Understand',
                    'Go Back'
                )
                setOverlayHandler(() => {
